...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument("kAtt", default_value="1.0", description="Scaling factor for the attractor vector in potential fields"),
            DeclareLaunchArgument("kRep", default_value="2.0", description="Scaling factor for the repulsive vector in potential fields"),
            DeclareLaunchArgument("var", default_value="1.57079", description="Defines the 'width' of the angular attenuation of the segments (lower values = more angles are take into consideration)"),
